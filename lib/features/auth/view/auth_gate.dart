...
/// auth state itself.
///
/// Deliberately still points at the v1 [ShellScreen]/v1 database once
/// ready — the v2 schema this session model is built on
/// (`lib/data/local/`) has no feature screens yet (tracked as the next
/// M1 PRs). Auth gates access to what exists today; it does not by
/// itself change which database a screen reads from.
