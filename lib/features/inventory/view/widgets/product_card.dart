...
class ProductCard extends GetView<InventoryController> {
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '${'buyLabel'.tr}৳${product.buyPrice.toStringAsFixed(2)}/${product.buyUnit}  •  ${'sellPriceLabel'.tr}৳${product.sellPrice.toStringAsFixed(2)}/${product.sellUnit}',
                    style: TextStyle(color: Colors.grey.shade600, fontSize: 12),
                  ),
                  const SizedBox(height: 3),
                  Text(
                    '${'stockLabel2'.tr}${dq.toStringAsFixed(2)} ${product.sellUnit}',
                    style: TextStyle(
            ...
            Column(
              ...
              children: [
                IconButton(
                  ...
                  onPressed: () => controller.processSale(product, false),
                  tooltip: 'sell'.tr,
  ...
  void _showEditDialog(BuildContext context) {
    ...
    final stockCtrl = TextEditingController(
      text: controller.displayQty(product).toStringAsFixed(1),
    );
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                keyboardType: TextInputType.number,
                decoration: InputDecoration(
                  labelText: '${'stock'.tr} (${product.sellUnit})',
                  border: const OutlineInputBorder(),
                ),
              ),
            ],
          ...
          ElevatedButton(
            ...
            onPressed: () {
              controller.updateProduct(
                ...
                buyPrice:
                    double.tryParse(buyPriceCtrl.text) ?? product.buyPrice,
                sellUnit: product.sellUnit,
                sellPrice:
                    double.tryParse(sellPriceCtrl.text) ?? product.sellPrice,
                stockQty:
                    double.tryParse(stockCtrl.text) ??
                    controller.displayQty(product),
              );
              Get.back();
            },
            child: Text('save'.tr),
